...
const ImageService = () => {
    ...
    const [formularioCompletado, setFormularioCompletado] = useState(false); // Nuevo estado
    ...
    const handleSendData = async (index, selectedValues) => {
        ...
        try {
            ...
            setFormularioCompletado(true); // Actualiza el estado cuando el formulario esté completado
    ...
    return (
        <div>
            ...
            {responseDataList.length > 0 && !formularioCompletado && (
                <div id="processing">
