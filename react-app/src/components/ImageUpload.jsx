...
const ImageUpload = ({ onImageUpload, loading, onImageProcessed }) => {
    ...
    return (
        <section id="upload">
            <h1 className='text-4xl font-semibold'>Módulo de Carga de Imágenes</h1>
            <p className='text-2xl py-10'>
                En este módulo, puedes cargar tu imagen facial para que sea analizada.</p>
            <form onSubmit={handleSubmit}>
                <input className='text-white' type="file" name="imagen" onChange={handleFileChange} />
                <button className='text-white' type="submit" disabled={!imagen || loading}>
